      ...
      <div class="form-container bg-white rounded-2xl shadow-2xl p-6 md:p-10 max-w-4xl mx-auto border border-purple-100">
        <div class="form-header text-center mb-8">
          ...
          <p class="form-description text-gray-600">
            Registrieren Sie Ihre Kleiderspende für die Abgabe an unserer Sammelstelle
          </p>
        </div>
          ...
          <div class="form-step mb-10">
            <div class="step-header flex items-start mb-6">
              ...
              <div class="step-info">
                ...
                <p class="step-description text-gray-600">Für eventuelle Rückfragen</p>
              </div>
            </div>
...
const quantityOptions = [
  { value: 'small', icon: '📦', label: 'Klein (1-2 Taschen)', desc: 'bis 15kg' },
  { value: 'medium', icon: '📦📦', label: 'Mittel (3-4 Taschen)', desc: '15-30kg' },
  { value: 'large', icon: '📦📦📦', label: 'Groß (5+ Taschen)', desc: 'über 30kg' }
]
